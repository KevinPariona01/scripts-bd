...
DELETE T_GED_PERSONA WHERE TX_PERSONA_CORREO is null
commit;
...
---
SELECT T.TX_TALLER_URL url FROM PACIRFIS.T_MVD_REGISTRO_TALLER R INNER JOIN T_MVD_PROYECTO_TALLER T on R.NU_ID_PROYECTO_NORMATIVO = T.NU_ID_PROYECTO WHERE (R.NU_ID_REGISTRO_TALLER = 186)


SELECT * FROM T_MVD_PROYECTO_TALLER 
DELETE T_MVD_PROYECTO_TALLER WHERE TX_TALLER_URL is null
DELETE T_MVD_PROYECTO_TALLER WHERE NU_ID_PROYECTO_TALLER = 62
commit;
